  ...
  return (
    <footer className="bg-white text-anthracite py-0 mt-auto">
      ...
      <div className="w-full py-8 md:py-12 border-b border-border-soft">
        <div className="text-center mb-6 md:mb-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-lg md:text-xl text-anthracite hover:text-warm-accent transition-colors duration-200"
          >
      ...
      <div className="container-custom py-12">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-12 items-start">
          {/* Logo - Ganz links als Eyecatcher */}
          ...
          <div className="hidden md:block">
            <h3 className="text-lg mb-4 text-anthracite">Navigation</h3>
            <nav>
          ...
          <div className="text-center md:text-left">
            <h3 className="text-lg mb-4 text-anthracite">Bereit für euer Shooting?</h3>
