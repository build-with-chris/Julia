          ...
          <div className="w-full px-4 md:px-6 lg:px-8 xl:px-12 pt-4 md:pt-6 lg:pt-[calc(7vh+32px)] pb-4 md:pb-6 lg:pb-8 flex flex-col justify-start overflow-y-auto lg:h-full">
            <div className="max-w-2xl mx-auto lg:mx-0 w-full">
              <div className="flex justify-end mb-6 md:mb-8">
                <h1 className="text-anthracite text-3xl md:text-4xl lg:text-5xl font-bold">
                  Jetzt kontaktieren.
                </h1>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5" noValidate>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
                    <label htmlFor="firstName" className="block text-anthracite mb-2 text-sm md:text-base">
                      Vorname*
                    </label>
                    <input
                      type="text"
                      ...
                      className={`w-full bg-offwhite border-b-2 text-anthracite placeholder-muted focus:outline-none transition-colors duration-200 pb-2 text-base md:text-lg ${
                        errors.firstName
                  ...
                  <div>
                    <label htmlFor="lastName" className="block text-anthracite mb-2 text-sm md:text-base">
                      Nachname*
                    </label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
                    <label htmlFor="email" className="block text-anthracite mb-2 text-sm md:text-base">
                      E-Mail*
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-anthracite mb-2 text-sm md:text-base">
                      Telefon
                    </label>
                    <input
                      type="tel"
                      ...
                      onChange={handleChange}
                      className="w-full bg-offwhite border-b-2 border-border-soft text-anthracite placeholder-muted focus:outline-none focus:border-warm-accent transition-colors duration-200 pb-2 text-base md:text-lg"
                      placeholder=""
                    />
                  </div>
                </div>
                ...
                <div>
                  <label htmlFor="message" className="block text-anthracite mb-2 text-sm md:text-base">
                    Nachricht*
                  </label>
                  <textarea
                    id="message"
                    ...
                    onChange={handleChange}
                    rows="4"
                    className={`w-full bg-offwhite border-b-2 text-anthracite placeholder-muted focus:outline-none transition-colors duration-200 pb-2 resize-none text-base md:text-lg ${
                      errors.message
                        ? 'border-warm-accent focus:border-warm-accent'
                        : 'border-border-soft focus:border-warm-accent'
                    }`}
                ...
                <div className="flex items-start gap-3 pt-2">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="privacy" className="text-anthracite text-sm md:text-base cursor-pointer">
                    Ich habe die Datenschutzerklärung gelesen und akzeptiert.*
                  </label>
                </div>

                {/* Pflichtfeld Hinweis */}
                <p className="text-muted text-xs md:text-sm">*Pflichtfeld</p>
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="px-8 md:px-12 py-3 md:py-4 border-2 border-warm-accent text-warm-accent uppercase tracking-wider font-medium hover:bg-warm-accent hover:text-offwhite transition-all duration-200 text-sm md:text-base disabled:opacity-50 disabled:cursor-not-allowed"
                  >
